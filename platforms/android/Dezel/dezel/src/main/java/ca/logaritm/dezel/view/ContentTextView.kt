 ...
 * @hidden
 */
open class ContentTextView(context: Context, listener: ContentTextViewListener?) : View(context), Resizable, Clippable {
	 ...
	 * @hidden
	 */
	internal var contentViewListener: ContentTextViewListener? = null
