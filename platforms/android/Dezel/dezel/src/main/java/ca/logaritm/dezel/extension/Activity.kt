 ...
 * @hidden
 */
public val Activity.viewport: SizeF; get() {
 ...
 * @hidden
 */
public val Activity.navigationBarSize: Size; get() {
 ...
 * @hidden
 */
public val Activity.navigationBarVisible: Boolean; get()  {
 ...
 * @hidden
 */
public val Activity.isSamsungDevice: Boolean
