 ...
 * @since 0.1.0
 */
open class DezelApplicationActivity : Activity(), KeyboardObserverListener {
	...
	companion object {
		 ...
		 * @since 0.1.0
		 */
		public fun from(context: JavaScriptContext): DezelApplicationActivity {
			return context.attribute("dezel.application.DezelApplicationActivity") as DezelApplicationActivity
		}
	}
