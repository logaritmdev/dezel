...
import ca.logaritm.dezel.view.ContentImageView
 ...
 * @hidden
 */
open class ImageView(context: JavaScriptContext) : View(context) {
	 ...
	 * @hidden
	 */
	private val view: ContentImageView
		get() = this.content as ContentImageView
	 ...
	 * @since 0.1.0
	 */
	override fun createContentView(): ContentImageView {
		return ContentImageView(this.context.application)
	}
