...
import ca.logaritm.dezel.view.ContentTextInput
import ca.logaritm.dezel.view.ContentTextInputListener
 ...
 * @since 0.1.0
 */
open class TextInput(context: JavaScriptContext) : View(context), ContentTextInputListener {
	 ...
	 * @hidden
	 */
	private val view: ContentTextInput
		get() = this.content as ContentTextInput
	 ...
	 * @since 0.1.0
	 */
	override fun createContentView(): ContentTextInput {
		return ContentTextInput(this.context.application, this)
	}
