...
#include <jni.h>
/* Header for class ca_logaritm_dezel_core_JavaScriptValueExternal */

#ifndef _Included_ca_logaritm_dezel_core_JavaScriptValueExternal
#define _Included_ca_logaritm_dezel_core_JavaScriptValueExternal
#ifdef __cplusplus
extern "C" {
#endif
/*
