...
#include <jni.h>
/* Header for class ca_logaritm_dezel_core_JavaScriptContextExternal */

#ifndef _Included_ca_logaritm_dezel_core_JavaScriptContextExternal
#define _Included_ca_logaritm_dezel_core_JavaScriptContextExternal
#ifdef __cplusplus
extern "C" {
#endif
/*
