 ...
 * @hidden
 */
open class ContentTextInput: UITextField, UITextFieldDelegate {
	 ...
	 * @hidden
	 */
	internal weak var contentViewDelegate: ContentTextInputDelegate?
	 ...
	 * @since 0.1.0
	 */
	public init(frame: CGRect, delegate: ContentTextInputDelegate?) {
		...
		let image = UIImage(named: "TextInputClearButtonIcon", in: Bundle(for: ContentTextInput.self), compatibleWith: nil)?.withRenderingMode(.alwaysTemplate)
