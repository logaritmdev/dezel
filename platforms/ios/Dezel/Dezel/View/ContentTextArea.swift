 ...
 * @hidden
 */
open class ContentTextArea: UITextView, UITextViewDelegate {
	 ...
	 * @hidden
	 */
	internal weak var contentViewDelegate: ContentTextAreaDelegate?
	 ...
	 * @since 0.1.0
	 */
	public init(frame: CGRect, delegate: ContentTextAreaDelegate?) {
