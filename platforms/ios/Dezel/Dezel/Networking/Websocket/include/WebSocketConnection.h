 ...
 */
-(void)websocketDidConnect:(nonnull WebSocketConnection*)socket;
 ...
 */
-(void)websocketDidDisconnect:(nonnull WebSocketConnection*)socket error:(nullable NSError*)error;
 ...
 */
-(void)websocket:(nonnull WebSocketConnection*)socket didReceiveMessage:(nonnull NSString*)string;
 ...
 */
-(void)websocket:(nonnull WebSocketConnection*)socket didReceiveData:(nullable NSData*)data;
...
/**
 Use for SSL pinning.
 */
@property(nonatomic, strong, nullable)WebSocketSecurity *security;
