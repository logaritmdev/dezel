 ...
 * @since 0.1.0
 */
open class TextInput: View, ContentTextInputDelegate {
	 ...
	 * @hidden
	 */
	private var view: ContentTextInput {
		return self.content as! ContentTextInput
	}
	 ...
	 * @since 0.5.0
	 */
	override open func createContentView() -> ContentTextInput {
		return ContentTextInput(frame: .zero, delegate: self)
	}
