 ...
 * @hidden
 */
open class TextView: View, ContentTextViewDelegate {
	 ...
	 * @hidden
	 */
	private var view: ContentTextView {
		return self.content as! ContentTextView
	}
	 ...
	 * @since 0.5.0
	 */
	override open func createContentView() -> ContentTextView {
		return ContentTextView(frame: .zero, delegate: self)
	}
