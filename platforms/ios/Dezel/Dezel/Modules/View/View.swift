...
open class View: JavaScriptClass, LayoutNodeDelegate, StylerNodeDelegate, ScrollableDelegate, UpdateDisplayCallback {
	 ...
	 * @since 0.1.0
	 */
	private(set) public var children: [View] = []
	 ...
	 * @since 0.1.0
	 */
	private(set) public var shadowed: [View] = []
	 ...
	 * @since 0.1.0
	 */
	private(set) public var shadowRoot: View? {
	 ...
	 * @since 0.1.0
	 */
	open func insert(_ view: View, at index: Int, notify: Bool = true) {

		let parent = self
		var window = self.window

		if (window == nil && self is Window) {
	 ...
	 * @since 0.2.0
	 */
	open func inject(_ view: View, at index: Int, notify: Bool = true) {
	 ...
	 * @since 0.2.0
	 */
	open func findViewAt(point: Point3D, matrix: Transform3D, visible: Bool = true, touchable: Bool = true) -> View? {
	 ...
	 * @hidden
	 */
	private func insertChild(_ view: View, at index: Int) {
	 ...
	 * @hidden
	 */
	private func updateShadowRoot(_ root: View?) {
	 ...
	 * @hidden
	 */
	private func appendShadowedView(_ view: View) {
	 ...
	 * @hidden
	 */
	private func removeShadowedView(_ view: View) {
	...
	@objc open func jsFunction_insert(callback: JavaScriptFunctionCallback) {
		self.insert(callback.argument(0).cast(View.self)!, at: callback.argument(1).number.int())
	}
	...
	@objc open func jsFunction_remove(callback: JavaScriptFunctionCallback) {
		self.remove(callback.argument(0).cast(View.self)!)
	}
...
public protocol ViewDelegate: class {
	func didBeginLayout(view: View)
	func didFinishLayout(view: View)
	func didScroll(view: View)
}
