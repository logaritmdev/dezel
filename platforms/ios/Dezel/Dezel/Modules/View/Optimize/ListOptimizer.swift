 ...
 * @since 0.4.0
 */
open class ListOptimizer : ContentOptimizer {
	 ...
	 * @since 0.5.0
	 */
	override open func didBeginLayout(view: View) {
	 ...
	 * @since 0.5.0
	 */
	override open func didFinishLayout(view: View) {
	 ...
	 * @since 0.5.0
	 */
	override open func didScroll(view: View) {
	 ...
	 * @hidden
	 */
	private func createItem(_ index: Int) -> View? {
		...
		guard let item = view.property("native").cast(View.self) else {
			return nil
		}
	 ...
	 * @hidden
	 */
	private func reuseItem(_ index: Int) -> View? {
	...
	*/
	private struct InsertItemData {
		 ...
		 * @hidden
		 */
		public init(view: View, index: Int) {
			self.view = view
			self.index = index
		}
	}
